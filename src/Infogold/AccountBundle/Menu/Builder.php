...
class Builder implements ContainerAwareInterface {
    ...
    public function Menu(FactoryInterface $factory, array $options) {
        ...
        $menu->addChild('Baza klientów', array('uri' => '#','childrenAttributes' => array(
            ...
            )))->setLabel('<i class="fa fa-edit"></i>Baza klientów<span class="fa fa-chevron-down"></span>')->setExtra('safe_label',true);      
        ...
        $menu->addChild('Produkty', array('route' => 'produkty'));
          ...
          $menu->addChild('Faktury', array('uri' => '#','childrenAttributes' => array(
                'class' => 'nav child_menu',
            )))->setLabel('<i class="fa fa-edit"></i>Faktury<span class="fa fa-chevron-down"></span>')->setExtra('safe_label',true);      
        ...
        $menu->addChild('Ustawienia', array('uri' => '#','childrenAttributes' => array(
                'class' => 'nav child_menu',
            )))->setLabel('<i class="fa fa-edit"></i>Ustawienia<span class="fa fa-chevron-down"></span>')->setExtra('safe_label',true);      
